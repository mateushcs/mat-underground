...
export const caseBriefs: Record<string, Record<ContentLang, { description: string; contribution: string; results: string }>> = {
  ...
  L3: {
    pt: { description: "O Solv é um SaaS B2B da Neo Ventures que ajuda empresas a organizar programas, ideias e projetos de inovação.", contribution: "Atuei como designer e PM, conduzindo o redesign, o design system, as pesquisas e a priorização do roadmap com a liderança.", results: "40% menos tempo gasto gerindo programas de inovação, 50% dos projetos passaram a usar a inscrição simplificada, as tags tiveram mais de 70% de adesão, o painel chegou a mais de 80% dos clientes e o tempo de aprovação caiu cerca de 35%." },
    en: { description: "Solv is Neo Ventures' B2B SaaS for organising innovation programmes, ideas and projects.", contribution: "As designer and PM, I led the redesign, design system, research and roadmap prioritisation with leadership.", results: "40% less time spent managing innovation programmes, 50% of projects adopted simplified sign-up, tags reached over 70% adoption, the dashboard reached over 80% of clients and approval time fell by around 35%." },
  },
  L4: {
...
const about: Record<ContentLang, string[]> = {
  pt: [
    ...
    "E teve resultado: no Uptime Center, o tempo de máquinas paradas caiu 35% e as manutenções perdidas diminuíram cerca de 35%. Na Tour House, o fluxo pelo WhatsApp deixou as aprovações 60 vezes mais rápidas. No Solv, o tempo gasto gerindo programas de inovação caiu 40%, e vi as soluções que desenhamos ganharem adesão. Gosto de acompanhar essa parte também, porque é quando dá pra ver o que mudou na rotina de quem usa.",
    "## Meu processo",
  ...
  en: [
    ...
    "And there were results: Uptime Center saw 35% less equipment downtime and around 35% fewer missed maintenance tasks. At Tour House, WhatsApp approvals became 60 times faster. At Solv, time spent managing innovation programmes fell by 40%, and I saw the solutions we designed gain adoption. I like following this part too, because it shows what actually changed in people's routines.",
    "## My process",
